...
class ModulacionFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_range = qtgui.Range(88000000, 108000000, 100000, 90700000, 200)
        ...
        self._GRX_win = qtgui.RangeWidget(self._GRX_range, self.set_GRX, "Ganancia de transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
